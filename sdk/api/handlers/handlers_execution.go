...
func executionErrorMessage(err error) *interfaces.ErrorMessage {
	...
	// Upstream error bodies, including Home refresh responses, are diagnostic input.
	// Only explicit in-process request termination above may bypass error sanitization.
