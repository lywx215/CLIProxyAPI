...
基线已由协调窗口确认是 DIAG-01 批准提交 `1f65d3ec10830245f22a58691e124c5129f75707`，仍须等待 DIAG-00 精确提交和清单摘要批准。测试真实 httpx client 的 proxy/mount/hook 顺序、框架保留的重复字段、流转非流正文读取结束；不替换底层 transport，不用诊断重新计算 usage。
